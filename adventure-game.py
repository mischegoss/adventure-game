...
def play_game():
    option1 = random.choice(["red box",
                             "blue box",
                             "basket of puppies",
                             "golden box with no key",
                             "very old book",
                             "Marauder's map",
                             "tiny black box",
                             "jar of something foul but glimmering"])

    option2 = random.choice(["old coffee can",
                             "purple box with feathers",
                             "invitation from a witch",
                             "mysterious envelope",
                             "very old pirate's map",
                             "box that says 'do not open'",
                             "magical pumpkin",
                             "a bag marked with skull and cross bones"])

    intro(option1, option2)


def intro(option1, option2):
    print_pause("You wake up one morning and find you"
                + " had an unexpected and unseen visitor.")
...
def open_it(option1, option2):
    print_pause("It is not every day that a "
                + option1 + " or a " + option2 +
                " turn up in your house.")
...
def foul_odor(option):
    ...
    print_pause("Touching the " + option
                + " unleashed an unimaginable stink! ")
    print_pause("The only thing that can save you " +
                "now is to use your time turner and start again")
...
def glimmering_treasures(option):
    ...
    print_pause("Touching the " + option
                + " unleashed an avalanche of treasures! ")
    print_pause("You are very rich! But do you do dare try again?")
    print_pause("Enter 1 to grab your time turner and try again.")
